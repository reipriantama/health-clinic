...
const Help = () => {
  return (
    <div
      className='sm:p-5
     xl:px-[162px] xl:pb-[150px]'
    >
      <div className='xl:flex text-[18px]'>
        <div className='flex flex-col gap-[45px] w-[607px]'>
          ...
          <div className='sm:flex sm:justify-center xl:flex xl:gap-5'>
        ...
        >
          <div
            className='sm:my-10
          flex flex-col shadow-xl p-[30px] w-[396px] h-[285px] gap-[45px]'
          >
