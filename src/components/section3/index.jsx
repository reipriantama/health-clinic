...
const WorkFlow = () => {
  return (
    <div className='sm:px-10 xl:px-[162px] pb-[150px]'>
      ...
      <div className='flex flex-col gap-[30px]'>
        ...
        <div className='sm:flex sm:flex-col-reverse xl:flex xl:flex-row'>
          ...
          <div className='xl:flex xl:gap-[50px] xl:ml-[113px] py-[61px]'>
            <div
            ...
            <div className='flex flex-col gap-[30px] '>
              ...
              <div className='xl:w-[664px] text-xl text-[#232323] leading-[32.4px]'>
        ...
        <div className='xl:flex'>
          <div className='xl:flex xl:gap-[50px] py-[30px]'>
            <div
              className='radial-progress text-[#04726C] border-2'
              style={{
                '--value': '50',
          ...
          <div className='w-[537px] h-[278px] bg-[#04726C] text-white p-[30px] text-base shadow-xl xl:ml-[65px]'>
            <div className='flex gap-[20px]'>
              <div className='flex flex-col'>
        ...
        <div className='sm:flex sm:flex-col-reverse xl:flex xl:flex-row'>
          ...
          <div className='xl:flex xl:gap-[50px] xl:ml-[113px] py-[30px]'>
            <div
              className='radial-progress text-[#04726C] border-2'
              style={{
                '--value': '75',
        ...
        <div className='xl:flex'>
          ...
          <div className='w-[537px] h-[293px] bg-[#04726C] text-white p-[30px] text-base shadow-xl xl:ml-[65px]'>
            <div className='flex gap-[20px]'>
              <div className='flex flex-col text-base'>
